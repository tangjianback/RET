	...
	*/
	...
	public:
		...
		*/
		...
		uint64_t lqq_target = 5000;
		uint32_t sequelize_time_per_packet = 210;
		...
		decreaseinterval
		*/
		uint64_t lqq_max_target = 10000;
		/* parameter pkt*/
		
		double lqqtargetaddsetp_f = 0.2;
		double lqqtargetdecrease = 0.1;
		uint32_t decreaseinterval = 50;
		uint32_t con_mark = 0;

		EventId decreaseEvent;
		void DecreaseEvent_f();
		void IncreaseEvent_f();
		void resetEvent_f();
		uint32_t last_flow_id = 0;
		uint32_t last_flow_id_remian_counter = 0;
