...
namespace ns3 {
	...
	*/
	...
	public:
		...
		static const uint32_t fCnt = 5000; // Max number of flows on a NIC, for TX and RX respectively. TX+RX=fCnt*2
	...
	protected:
		...
		*/
		...
		bool ShouldSendCN_my(uint32_t indev, uint32_t ifindex, uint32_t qIndex);
		uint32_t m_qeq;
		uint32_t m_speedup;
		double m_w;
		//int32_t m_qOld[fCnt];
