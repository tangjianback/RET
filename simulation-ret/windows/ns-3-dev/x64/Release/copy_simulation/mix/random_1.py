...
for i in range(3,int(line_num)+2):
	if random.randint(1,10) < 3:
		...
		f.write(str(random.randint(3,64))+" 1 3 "+str(random.randint(50,5000))+ " "+str(random.randint(2,6))+"."+str(random.randint(0,999999))+str(random.randint(0,0))+str_out+str(rate)+ "\n")
